...
extension CategoryByIndex on IsarCollection<Category> {
  Future<Category?> getByCategory(String category) {
    return getByIndex(r'category', [category]);
  }

  Category? getByCategorySync(String category) {
  ...
  Future<List<Category?>> getAllByCategory(List<String> categoryValues) {
    final values = categoryValues.map((e) => [e]).toList();
    return getAllByIndex(r'category', values);
  }

  List<Category?> getAllByCategorySync(List<String> categoryValues) {
    final values = categoryValues.map((e) => [e]).toList();
  ...
  Future<Id> putByCategory(Category object) {
    return putByIndex(r'category', object);
  }

  Id putByCategorySync(Category object, {bool saveLinks = true}) {
    return putByIndexSync(r'category', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByCategory(List<Category> objects) {
    return putAllByIndex(r'category', objects);
  }

  List<Id> putAllByCategorySync(List<Category> objects,
      {bool saveLinks = true}) {
...
extension CategoryQueryWhere on QueryBuilder<Category, Category, QWhereClause> {
  ...
  QueryBuilder<Category, Category, QAfterWhereClause> categoryEqualTo(
      String category) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Category, Category, QAfterWhereClause> categoryNotEqualTo(
      String category) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
